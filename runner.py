...
class CodeRunner:
    ...
    def run_with_input(
        ...
        actual_time_limit = time_limit if time_limit is not None else self.config['execution']['max_time']
        actual_memory_limit = memory_limit if memory_limit is not None else self.config['execution']['max_memory']
